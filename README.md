...
## Project links
- [ Weights & Biases ](https://wandb.ai/younes-team/nyc_airbnb?workspace=user-younes_kebour)
- [ Github repository ](https://github.com/younes-code/build-ml-pipeline-for-short-term-rental-prices)
